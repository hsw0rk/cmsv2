...
const User = () => {
    ...
    useEffect(() => {
        const fetchBranches = async () => {
            const res = await axios.get("http://localhost:8800/api/auth/getbrancheinuser");
    ...
    const samplecsv = [
        { id: "", employeename: "", employeecode: "", mobilenumber: "", password: "", RegionCode: "", RegionName: "", Branchname1: "", Branchcode1: "" }
    ]
    ...
    return (
        ...
        <div className="form">
            ...
            <div className="form-container-branch">
                ...
                <div className={`additional-branches ${showAdditionalBranches ? 'show' : ''}`}>
                    <div>
                        <label>
                            Branch Name 1
                            <select
